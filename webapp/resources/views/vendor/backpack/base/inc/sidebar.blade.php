      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img src="{{ 'https://placehold.it/160x160/FACC2F/ffffff/&text='.Auth::user()->name[0] }}" class="img-circle" alt="User Image">
          </div>
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="{{ url(config('backpack.base.route_prefix').'/monster') }}"><i class="fa fa-optin-monster"></i> <span>Educations</span></a></li>
